  ...
  return (
    <>
      <div className="create-product">
        <form className="form-create" action="" method="get" onSubmit={HandleonSubmit}>
        <table className="create-product__table" >
          <tbody>
            <tr className="create-product__table__field">
              ...
              <td>
                <input type="text" name="name" id="" onChange={onchangeData}/>
              </td>
            </tr>
            <tr className="create-product__table__field">
            ...
            <tr className="create-product__table__field">
              ...
              <td>
                <input type="number" name="price" id="" min={0}  onChange={onchangeData}/>
              </td>
            </tr>
            <tr className="create-product__table__field">
              <td className="create-product__table__field__label">%Giảm giá</td>
              <td>
                <input type="number" min={0} name="discount" id="" onChange={onchangeData} />
              </td>
            </tr>
            <tr className="create-product__table__field">
              <td className="create-product__table__field__label">Số lượng</td>
              <td>
                <input type="text" name="stock_quantity" id=""  onChange={onchangeData} />
              </td>
            </tr >
            <tr className="create-product__table__field">
            ...
            <tr className="create-product__table__field">
              ...
              <td>
                <select  name="categories_id" onChange={onchangeData}>
                  {[...dataCategories].map((item,_)=> <option value={item._id}>{item.title}</option>)}  
            ...
            <tr className="create-product__table__field">
              ...
              <td>
                <span className="create-product__table__field__radio">
                  <input type="radio" name="status" value={"active"} onChange={onchangeData}/>
                  <label>Hoạt động</label>
                </span>
                <span className="create-product__table__field__radio">
                  <input type="radio" name="status" value={"inactive"} onChange={onchangeData} />
